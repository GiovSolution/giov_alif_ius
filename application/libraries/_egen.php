...
?>";
	...
	function CControllerExtjs($path,$nfile,$tbl,$data){
		$tulis = "Ext.define('INVENT.controller.".strtoupper($nfile)."',{
	...
	init: function(){
		this.control({
			...
			'v_".$nfile." button[action=create]': {
				click: this.createRecord
			},
			'v_".$nfile." button[action=delete]': {
				click: this.deleteRecord
			},
			'v_".$nfile." button[action=xexcel]': {
				click: this.export2Excel
			},
			'v_".$nfile." button[action=xpdf]': {
				click: this.export2PDF
			},
			'v_".$nfile." button[action=print]': {
	...
	".$nfile."AfterRender: function(){
		...
		var myGridView = getV_".$nfile.".getView();
		var mapgrid = Ext.create('Ext.util.KeyMap', {
			...
			binding: {
				...
				fn: function(keyCode, e) {
					var getstore = me.getV_".$nfile."().getStore();
					var selection = me.getV_".$nfile."().getSelectionModel().getSelection()[0];
	...
	deleteRecord: function(dataview, selections){
		var getstore = this.getV_".$nfile."().getStore();
		var selection = this.getV_".$nfile."().getSelectionModel().getSelection()[0];
		if(selection){
	...
	printRecords: function(){
		...
		if ( ! write_file("./ext/app/controller/".strtoupper($nfile).".js", $tulis))
		{
			return 0;
		}
		else
		{
			echo "<strong>Controller Extjs telah digenerate...!!!<br /> Lokasi : "."./ext/app/controller/".strtoupper($nfile).".js </strong><br />";
			return 1;
		}
	}
...
<table class=\"gridtable\" cellspacing=\"0\" summary=\"INVENT - ".$nfile."\">
	...
	function CModelExtjs($path,$nfile,$tbl,$data){
		$tulis = "Ext.define('INVENT.model.m_".$nfile."', {
...
$tulis .= "	
		...
		if ( ! write_file("./ext/app/model/m_".$nfile.".js", $tulis))
		{
			return 0;
		}
		else
		{
			echo "<strong>Model Extjs telah digenerate...!!!<br /> Lokasi : "."./ext/app/model/m_".$nfile.".js </strong><br />";
			return 1;
		}
	}
	...
	function CStoreExtjs($path,$nfile,$tbl,$data){
		$tulis = "Ext.define('INVENT.store.s_".$nfile."', {
	extend	: 'Ext.data.Store',
	alias	: 'widget.".$nfile."Store',
	model	: 'INVENT.model.m_".$nfile."',
	...
	constructor: function(){
		...
		if ( ! write_file("./ext/app/store/s_".$nfile.".js", $tulis))
		{
			return 0;
		}
		else
		{
			echo "<strong>Store Extjs telah digenerate...!!!<br /> Lokasi : "."./ext/app/store/s_".$nfile.".js </strong><br />";
			return 1;
		}
	}
	...
	function CViewExtjs($path,$nfile,$tbl,$data){
		$tulis = "Ext.define('INVENT.view.".$data['pathjs'].".v_".$nfile."', {
...
foreach($data['fields'] as $field)
{
	...
	refreshSelection: function() {
		...
		if ( ! write_file("./ext/app/view/".$data['pathjs']."/v_".$nfile.".js", $tulis))
		{
			return 0;
		}
		else
		{
			echo "<strong>View Extjs telah digenerate...!!!<br /> Lokasi : "."./ext/app/view/".$data['pathjs']."/v_".$nfile.".js </strong><br />";
			return 1;
		}
	}
	...
	initComponent: function(){
		...
		if ( ! write_file("./ext/app/view/".$data['pathjs']."/".strtoupper($nfile).".js", $tulis))
		{
			return 0;
		}
		else
		{
			echo "<strong>Viewport Extjs telah digenerate...!!!<br /> Lokasi : "."./ext/app/view/".$data['pathjs']."/".strtoupper($nfile).".js </strong><br />";
			return 1;
		}
	}
...
?>";
	...
	init: function(){
		this.control({
			...
			'v_".$nfile."_form': {
				'afterrender': this.v_".$nfile."_formAfterRender
			},
			'v_".$nfile." button[action=create]': {
				click: this.createRecord
			},
	...
	v_".$nfile."_formAfterRender: function(window, options){
		var me = this;
				...
				success: function(response){
					store.reload({
						callback: function(){
							...
							/* getV_".$nfile.".getView().select(recordIndex); */
							getV_".$nfile.".getSelectionModel().select(newRecordIndex);
						}
					});
...
foreach($data['fields'] as $field)
{
	...
	function CFormExtjs($path,$nfile,$tbl,$data){
		$tulis = "Ext.define('INVENT.view.".$data['pathjs'].".v_".$nfile."_form', {
	extend	: 'Ext.form.Panel',
    ...
    initComponent: function(){
		...
		if ( ! write_file("./ext/app/view/".$data['pathjs']."/v_".$nfile."_form.js", $tulis))
		{
			return 0;
		}
		else
		{
			echo "<strong>Form Extjs telah digenerate...!!!<br /> Lokasi : "."./ext/app/view/".$data['pathjs']."/v_".$nfile."_form.js </strong><br />";
			return 1;
		}
	}
