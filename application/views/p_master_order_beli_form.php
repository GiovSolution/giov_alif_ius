			...
			<td style="width: 4.25in;">
				<table width="100%" cellpadding="0" cellspacing="0" border="0">
					<tr>
						...
						<td style="border: 0px;"><?php print $row->order_no;?></td>
					</tr>
					<tr>
						<td style="border: 0px;">Tanggal</td>
						<td style="border: 0px;">:</td>
						<td style="border: 0px;"><?php print date('d-M-Y', strtotime($row->order_tanggal));?></td>
					</tr>
				</table>
			</td>
			<td style="width: 4.25in;">
			...
			<td style="width: 8.5in;" colspan="2">
				<table width="100%" cellpadding="0" cellspacing="0" border="1">
					...
					<tr>
						...
						<td style="text-align: right;"><?php print number_format($row->dorder_jumlah,0,',','.');?></td>
						<td style="text-align: right;"><?php print number_format($row->dorder_harga,0,',','.');?></td>
						<td style="text-align: right;"><?php print number_format($row->dorder_diskon,0,',','.');?></td>
						<td style="text-align: right;"><?php print number_format($row->dorder_subtotal,0,',','.');?></td>
					</tr>
					<?php
							$total+=$row->dorder_subtotal;
							$i++;
						}
					}
					?>
