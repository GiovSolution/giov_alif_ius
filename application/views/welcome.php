...
<head>
	...
	#Jika Aplikasi BELUM di Deployment menggunakan SDK Sencha, maka HILANGKAN file all-classes.js
	 -->
	<!-- <script type="text/javascript" src="<;?php echo base_url();?>ext/all-classes.js"></script> -->
	...
	#Jika Aplikasi BELUM di Deployment menggunakan SDK Sencha, maka TETAP menggunakan file app.js
	 -->
    <script type="text/javascript" src="<?php echo base_url();?>ext/app/app.js"></script>
...
<body>
    ...
    <div id="loading">
        <div class="loading-indicator">
            <img src="<?php echo base_url();?>assets/ext-4.2/resources/images/loading.gif" style="margin-right:8px;float:left;vertical-align:top;"/>
        </div>
    </div>
